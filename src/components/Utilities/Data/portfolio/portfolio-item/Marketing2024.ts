...
const Marketing2024: PortfolioItem = {
    id: "agencia-marketing-2024",
    presentation: {
        title: {
            es: "Agencia de Marketing 2024",
            en: "Marketing Agency 2024"
        },
        description: {
            es: "Trabajo freelance de campañas, branding y automatización orientada a captación de clientes.",
            en: "Freelance work across campaigns, branding and automation focused on lead acquisition."
        },
        slogan: {
            es: "Campañas, chatbots y generación de leads con enfoque práctico.",
    ...
    data: {
        ...
        core_features: {
            es: [
                "CRMs comerciales",
                "Meta Ads",
                "Automatización omnicanal de chatbots"
            ],
            en: [
                "Commercial CRMs",
                "Meta Ads",
                "Omnichannel chatbot automation"
            ]
        },
        categories: [
            {
